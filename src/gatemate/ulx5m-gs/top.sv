/*
    top.sv - NanoMig on CologneChop Gatemate
*/ 
...
`else
// Fake clocks without pll
reg [7:0] pll_lock_cnt = 8'h00;
always @(posedge clk)
  if(pll_lock_cnt != 8'd255)
    pll_lock_cnt <= pll_lock_cnt + 1;
     
assign pll_lock = pll_lock_cnt == 255;
assign clk_pixel_x5 = clk;
assign clk_85m = clk;
